...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <title>Detalhe da Reunião</title>    
    <link href="../css/wdcalendar/main.css" rel="stylesheet" type="text/css" />       
    <link href="../css/wdcalendar/dp.css" rel="stylesheet" />    
    <link href="../css/wdcalendar/dropdown.css" rel="stylesheet" />    
    <link href="../css/wdcalendar/colorselect.css" rel="stylesheet" />   
    ...
    <script src="../js/wdcalendar/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="../js/wdcalendar/Plugins/jquery.validate.js" type="text/javascript"></script>     
    ...
    <script src="../js/wdcalendar/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="../js/wdcalendar/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
